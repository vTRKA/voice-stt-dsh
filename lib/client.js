window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const SHORTCUT_STORAGE_KEY$1 = "dsh.parakeet.shortcut";
		const SHORTCUT_EVENT$1 = "dsh.parakeet.shortcut.changed";
		function defaultShortcut$1(platform) {
		...
		function VoiceInputButton({ input, inputActions, t }) {
			...
			const [shortcut, setShortcut] = (0, react.useState)(() => defaultShortcut$1(navigator.platform));
			...
			(0, react.useEffect)(() => {
				try {
					const stored = localStorage.getItem(SHORTCUT_STORAGE_KEY$1);
					...
					if (legacyDefault) localStorage.setItem(SHORTCUT_STORAGE_KEY$1, JSON.stringify(migrated));
				} catch {
					localStorage.removeItem("dsh.parakeet.shortcut");
				}
			}, []);
			(0, react.useEffect)(() => {
				const onShortcutChanged = (event) => {
					const detail = event.detail;
					if (detail === null || typeof detail !== "object" || typeof detail.key !== "string" || typeof detail.ctrl !== "boolean" || typeof detail.alt !== "boolean" || typeof detail.shift !== "boolean" || typeof detail.meta !== "boolean" || !detail.ctrl && !detail.alt && !detail.shift && !detail.meta) return;
					setShortcut({
						ctrl: detail.ctrl,
						alt: detail.alt,
						shift: detail.shift,
				...
				window.addEventListener(SHORTCUT_EVENT$1, onShortcutChanged);
				return () => {
					window.removeEventListener(SHORTCUT_EVENT$1, onShortcutChanged);
				};
			}, []);
			(0, react.useEffect)(() => () => {
			...
			(0, react.useEffect)(() => {
				const toggle = (event) => {
					...
					if (editingShortcut) {
						...
						setEditingShortcut(false);
						setShortcutNotice("shortcut.saved");
						localStorage.setItem(SHORTCUT_STORAGE_KEY$1, JSON.stringify(next));
						window.dispatchEvent(new CustomEvent(SHORTCUT_EVENT$1, { detail: next }));
						return;
					}
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Tooltip, {
				...
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
					...
					onClick: (event) => {
						if (event.shiftKey) beginShortcutEditing();
		...
		//#endregion
		//#region src/client/ParakeetSettingsTab.tsx
		const SHORTCUT_STORAGE_KEY = "dsh.parakeet.shortcut";
		const SHORTCUT_EVENT = "dsh.parakeet.shortcut.changed";
		...
		function readShortcut() {
			const fallback = defaultShortcut(typeof navigator === "undefined" ? "" : navigator.platform);
			try {
				const parsed = JSON.parse(localStorage.getItem(SHORTCUT_STORAGE_KEY) ?? "");
				if (typeof parsed.key !== "string" || parsed.key.length === 0 || typeof parsed.ctrl !== "boolean" || typeof parsed.alt !== "boolean" || typeof parsed.shift !== "boolean" || typeof parsed.meta !== "boolean" || !parsed.ctrl && !parsed.alt && !parsed.shift && !parsed.meta) return fallback;
				return {
					ctrl: parsed.ctrl,
					alt: parsed.alt,
					shift: parsed.shift,
		...
		function saveShortcut(shortcut) {
			...
			window.dispatchEvent(new CustomEvent(SHORTCUT_EVENT, { detail: shortcut }));
		}
		/** A platform-aware shortcut editor that shares the voice button's local setting. */
		function ParakeetSettingsTab({ t }) {
			const [shortcut, setShortcut] = (0, react.useState)(() => readShortcut());
			...
			const current = label(shortcut);
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
				"aria-labelledby": "parakeet-settings-heading",
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("h3", {
						id: "parakeet-settings-heading",
						children: "Parakeet Voice Input"
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", { children: "Offline speech recognition using the downloaded Parakeet model." }),
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("p", { children: [
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("strong", { children: "Recording shortcut:" }),
						" ",
						current
					] }),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
						...
						onClick: () => {
							setCapturing(true);
							setNotice("shortcut.capture");
						},
						children: capturing ? "Press a shortcut (Esc to cancel)" : "Change shortcut"
					}),
					notice !== null ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
						role: "status",
						children: t(notice)
					}) : null,
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", { children: "Press the shortcut once to start recording and again to stop. No microphone-button click is required." })
				]
			});
		}
		//#endregion
		...
		const zh = {
			...
			"shortcut.change": "Shift-click or right-click to change the shortcut",
		...
		*/
		function apply(ctx) {
			...
			ctx.slots.inject("settings.plugins.tab", () => ctx.slots.register({
				...
				id: "parakeet-voice-input",
				order: 10,
				label: "Parakeet Voice Input",
				locale: NS
			}, ParakeetSettingsTab));
		}
		//#endregion
